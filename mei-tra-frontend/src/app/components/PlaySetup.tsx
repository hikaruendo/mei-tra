...
export function PlaySetup({ player, agariCard, onSelectNegri }: PlaySetupProps) {
  ...
  return (
    <div className="play-setup mt-4 p-4 bg-gray-800 rounded-lg shadow-lg">
      <div className="text-center mb-4">
        ...
        <p className="text-gray-300 mt-2">You won the blow phase! Select one card from your hand as Negri.</p>
      </div>
      ...
      <div className="hand-section">
        <h4 className="text-xl font-bold text-white mb-2">Select Negri Card</h4>
