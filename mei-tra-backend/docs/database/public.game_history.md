...
| actor_key_snapshot | text                     |                    | true     |                                                                               | Immutable actor key snapshot retained when an actor seat is unavailable.              |
| actor_seat_id      | uuid                     |                    | true     | [public.room_players](public.room_players.md)                                 | Actor seat UUID when the action is tied to a room seat. |
