...
| public.claim_room_membership              | jsonb         | p_user_id uuid, p_room_id uuid, p_seat_id uuid, p_transition_id uuid                                                                                                                                                                                                                | FUNCTION |
...
| public.release_room_membership_by_seat    | bool          | p_room_id uuid, p_seat_id uuid, p_transition_id uuid                                                                                                                                                                                                                               | FUNCTION |
...
| public.reserve_room_membership            | jsonb         | p_user_id uuid, p_seat_id uuid, p_transition_id uuid                                                                                                                                                                                                                               | FUNCTION |
